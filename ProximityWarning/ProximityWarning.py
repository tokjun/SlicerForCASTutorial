...
class ProximityWarning(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "ProximityWarning"  # TODO: make this more human readable by adding spaces
...
See more information in <a href="https://github.com/organization/projectname#ProximityWarning">module documentation</a>.
"""
...
def registerSampleData():
  ...
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    ...
    category='ProximityWarning',
    sampleName='ProximityWarning1',
    # Thumbnail should have size of approximately 260x280 pixels and stored in Resources/Icons folder.
    # It can be created by Screen Capture module, "Capture all views" option enabled, "Number of images" set to "Single".
    thumbnailFileName=os.path.join(iconsPath, 'ProximityWarning1.png'),
    # Download URL and target file name
    uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
    fileNames='ProximityWarning1.nrrd',
    # Checksum to ensure file integrity. Can be computed by this command:
    #  import hashlib; print(hashlib.sha256(open(filename, "rb").read()).hexdigest())
    checksums = 'SHA256:998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95',
    # This node name will be used when the data set is loaded
    nodeNames='ProximityWarning1'
  )
  ...
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    # Category and sample name displayed in Sample Data module
    category='ProximityWarning',
    sampleName='ProximityWarning2',
    thumbnailFileName=os.path.join(iconsPath, 'ProximityWarning2.png'),
    # Download URL and target file name
    uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
    fileNames='ProximityWarning2.nrrd',
    checksums = 'SHA256:1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97',
    # This node name will be used when the data set is loaded
    nodeNames='ProximityWarning2'
  )
...
class ProximityWarningWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/ProximityWarning.ui'))
    ...
    self.logic = ProximityWarningLogic()
...
class ProximityWarningLogic(ScriptedLoadableModuleLogic):
...
#
# ProximityWarningTest
#

class ProximityWarningTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_ProximityWarning1()

  def test_ProximityWarning1(self):
    ...
    import SampleData
    registerSampleData()
    inputVolume = SampleData.downloadSample('ProximityWarning1')
